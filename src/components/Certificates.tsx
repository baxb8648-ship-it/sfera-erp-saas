      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16 text-center max-w-2xl mx-auto">
          ...
          <p className="text-text-muted text-sm font-medium leading-relaxed">
            Производство работ промышленной группы СФЕРУМ полностью стандартизировано. Мы гарантируем соблюдение строительных норм и прохождение проверок любого технадзора.
          </p>
        </div>
