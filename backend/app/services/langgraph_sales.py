...
Мы предлагаем внедрение ERP-системы "СФЕРА", которая закроет их хаос в учете, складе и задачах.
...
Напиши мощное, персонализированное письмо для отправки директору (обращайся по имени отчеству, если известно, или просто уважаемый руководитель). Без воды."""
    ...
    if not proposal:
        proposal = "Офлайн-режим (LLM недоступна). Шаблонное предложение: Здравствуйте, предлагаем внедрить СФЕРА ERP для оптимизации ваших процессов."
